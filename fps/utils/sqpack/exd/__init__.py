...
class ExdManager:
    ...
    def __init__(self, pack: 'PackManager', default_language: Language = Language.en, res_path=b"exd/root.exl", exd_keep_in_memory=True):
        self.default_language = default_language
        self.exd_keep_in_memory = exd_keep_in_memory
        self.sheets = {}
        self.pack = pack
    ...
    def _build(self, res_path):
        ...
        self.exd_pack.keep_in_memory = self.exd_keep_in_memory
    ...
    def get_sheet(self, row_type: Type[_T] | str) -> Sheet[_T]:
        if isinstance(row_type, str):
            return self.get_sheet_raw(row_type)
